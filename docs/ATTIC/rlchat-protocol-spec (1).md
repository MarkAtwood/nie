...
```json
"pushProxy": {
  "endpoint": "https://push.example.com/rlchat/push/v1",
  "proxyDID": "did:key:z6MkProxy...",
  "platforms": ["apns", "fcm"],
  "registrationEndpoint": "https://push.example.com/rlchat/push/v1/register"
}
```
...
```
POST /rlchat/kp/v1/../push/register
     (or a dedicated endpoint on the relay)
{
  "pushHandle": "base64url...",
  "proxyEndpoint": "https://push.example.com/rlchat/push/v1"
}
```
...
```
POST https://push.example.com/rlchat/push/v1/wake
x-rlchat-relay-did: did:key:z6MkRelay...
x-rlchat-timestamp: 1741780800
...
4. Delete old `pushHandle` from proxy: `DELETE /rlchat/push/v1/register/{pushHandle}`
